...
import './CSSIAward2023-04-16.css'
import { useCart } from "react-use-cart";

const dibbs_data = await (await fetch('https://gov-scrape-1.herokuapp.com/CSSIAward2023-04-16/')).json();
// const dibbs_data = await (await fetch('http://localhost:5000/CSSIAward2023-04-16/')).json();
// const sen_dibbs_data = await (await fetch('http://localhost:5000/sen_CSSIAward2023-04-16/')).json();

const CSSIAward2023_04_16 = () => {


  return (
    <>
      <div id="altshoponly">
      <h1 class="title">CSSI Award</h1>
...
export default CSSIAward2023_04_16