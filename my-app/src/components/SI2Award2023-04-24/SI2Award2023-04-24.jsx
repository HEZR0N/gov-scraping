...
import './SI2Award2023-04-24.css'
import { useCart } from "react-use-cart";

const dibbs_data = await (await fetch('https://gov-scrape-1.herokuapp.com/SI2Award2023-04-24/')).json();
// const dibbs_data = await (await fetch('http://localhost:5000/SI2Award2023-04-24/')).json();
// const sen_dibbs_data = await (await fetch('http://localhost:5000/sen_SI2Award2023-04-24/')).json();

const SI2Award2023_04_24 = () => {


  return (
    <>
      <div id="altshoponly">
      <h1 class="title">SI2 Award</h1>
...
export default SI2Award2023_04_24